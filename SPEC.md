...
- [Frontend (`web/`)](#frontend-web) · [Tech stack](#frontend-tech-stack) · [Design system](#design-system) · [Auth flow](#auth-flow) · [Public pages](#public-pages) · [Legal pages](#legal-pages) · [Route guard](#route-guard) · [Caching](#caching-use-cache) · [Board view](#board-view) · [Toast feedback](#toast-feedback) · [i18n](#i18n) · [Installable app](#installable-app)
