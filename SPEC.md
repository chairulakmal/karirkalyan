...
| `validation_failed` | `422` | Model validation failure (create/update, file upload, or a per-user ceiling — detail code `too_many_applications` or `too_many_passkeys` on field `base`); carries `details` |
